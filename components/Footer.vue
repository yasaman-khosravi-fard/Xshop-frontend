      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="mb-8 max-w-[270px] text-base text-gray-7">
                ما با استفاده از آن، تجربیات دیجیتالی را برای برندها و شرکت ها ایجاد می کنیم
                فن آوری.
              </p>
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">درباره ما</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">امکانات</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">آخرین نوشته ها</h4>
